...
public static class ProjectVariableSetsEndpoint
{
    ...
    private static async Task<Ok<List<VariableSetResponse>>> GetProjectVariableSets(
    ...
    private static async Task<NoContent> LinkVariableSetToProject(
        [FromRoute] Guid projectId,
    ...
    private static async Task<NoContent> UnlinkVariableSetFromProject(
        [FromRoute] Guid projectId,
        [FromRoute] Guid setId,
        [FromServices] ISender sender,
        CancellationToken ct)
